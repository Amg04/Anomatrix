        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Num_humans = table.Column<int>(type: "int", nullable: false),
                    Weapon_count = table.Column<int>(type: "int", nullable: false),
                    Abnormal_count = table.Column<int>(type: "int", nullable: false),
                    Is_crowded = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CameraDetections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CameraDetections_Cameras_CameraId",
                        column: x => x.CameraId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CameraDetections_CameraId",
                table: "CameraDetections",
                column: "CameraId");
